    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <section class="md:col-span-3">
            ...
            <div class="container mx-auto p-4">
                ...
                <div x-data="{ open: false}" id="applicant-form">
                    ...
                    <div x-cloak x-show="open" class="fixed inset-0 flex item-center justify-center bg-gray-900 bg-opacity-50">
                        <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">

                            <h3 class="text-lg font-semibold mb-4">Apply For {{$job->title}}</h3><br>
                ...
                @else
                <p class="my-5 bg-red-200 rounded-xl p-3  ">
                    <i class="fas fa-info-circle mr-3"></i>
                    You must be logged in to Apply for this
                </p>
                @endauth
            </div>
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            <p class="mt-10 bg-gray-200 text-gray-700 font-bold w-full py-2 px-4 rounded-full text-center">
                <i class="fas fa-info-circle mr-3"></i>
                You Must Be Log Into Bookmark A Job
            </p>
            @else
